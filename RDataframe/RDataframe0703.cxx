 ...
 * Foundation, Inc., 51 Franklin Street, Fifth Floor, Boston,    cout << "variable data pointer: " << variable1.getVarData() << endl;
 * MA 02110-1301, USA.
 *
...
class Node {
    ...
    protected:
        ...
        void* ptrData;
        /** an integer holding number of rows in the Node data vector
         * (it's length)*/
        int nrows;
...
//    int nrows = colhead.length
    ...
    cout << "  bet variable data range:          " << variable1.getVarDataRange(0,11);
